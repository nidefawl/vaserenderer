...
void line_init( int N)
{
	...
	case 4:
		AP[0].x=139.002686; AP[0].y=33.885098;
		AP[1].x=139.505798; AP[1].y=32.570778;
		AP[2].x=140.008911; AP[2].y=33.595139;
		AP[3].x=140.511963; AP[3].y=36.403633;
		AP[4].x=141.015076; AP[4].y=41.283951;
		AP[5].x=141.518188; AP[5].y=46.364094;
		AP[6].x=142.021301; AP[6].y=51.302628;
		AP[7].x=142.524414; AP[7].y=54.042339;
		AP[8].x=143.027466; AP[8].y=54.071541;
		AP[9].x=143.530579; AP[9].y=51.255283;
		AP[10].x=144.033691; AP[10].y=46.125885;
		AP[11].x=144.536804; AP[11].y=41.272156;
		AP[12].x=145.039856; AP[12].y=37.874550;
		AP[13].x=145.542969; AP[13].y=37.475441;
		AP[14].x=146.046082; AP[14].y=40.449226;
		AP[15].x=146.549133; AP[15].y=45.435368;
		AP[16].x=147.052246; AP[16].y=50.693375;
		AP[17].x=147.555359; AP[17].y=55.040535;
		AP[18].x=148.058472; AP[18].y=56.502079;
		AP[19].x=148.561584; AP[19].y=54.791592;
		weight->value(2.0);
		size_of_AP = 20;
	break;
